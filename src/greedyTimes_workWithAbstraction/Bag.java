package greedyTimes_workWithAbstraction;

import java.util.*;

import static greedyTimes_workWithAbstraction.Type.*;
...
public class Bag {
    ...
    private void printItemByGroup(Type type) {
